...
public class Pago {
    ...
    private int id_tipo; // ✅ Nuevo campo (relación con TipoPago)
    ...
    public int getId_tipo() { return id_tipo; }   // ✅ Getter
    public void setId_tipo(int id_tipo) { this.id_tipo = id_tipo; } // ✅ Setter
